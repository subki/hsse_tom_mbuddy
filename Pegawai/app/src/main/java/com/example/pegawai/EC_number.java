...
public class EC_number extends AppCompatActivity {
    ...
    String batch;
    String Pids, Pnama, Pnomor, Ptelepon;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ec_number);

        spinBatch = (Spinner) findViewById(R.id.spinnerBatch);
        listViewPhone = (ListView) findViewById(R.id.listViewECN);
        nomorid = (TextView) findViewById(R.id.txtids);

//        nomorid.setVisibility(View.GONE);
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    case R.id.nav_employee:
                        startActivity(new Intent(EC_number.this,Employee.class));
                        return true;
                    case R.id.nav_license:
                        startActivity(new Intent(EC_number.this,License.class));
                        return true;
                    case R.id.nav_goal:
                        startActivity(new Intent(EC_number.this,Goal_zero.class));
                        return true;
                    case R.id.nav_erp:
                        startActivity(new Intent(EC_number.this,ER_Procedure.class));
                        return true;
                    case R.id.nav_ecn:
                        startActivity(new Intent(EC_number.this,EC_number.class));
                        return true;
                    case R.id.nav_number:
                        startActivity(new Intent(EC_number.this,Team_number.class));
                        return true;
                    case R.id.nav_logout:
                        ...
                        editor.clear();
                        editor.commit();
                        Intent intent = new Intent(EC_number.this, MainActivity.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        startActivity(intent);
                        Toast.makeText(EC_number.this, "Logout clicked", Toast.LENGTH_SHORT).show();
                        return true;
                }
                return true;
            }
        ...
        spinBatch.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onNothingSelected(AdapterView<?> parent) {
                Toast.makeText(EC_number.this, "Not Selected Anything", Toast.LENGTH_SHORT).show();
            }
        });
    }
    class LoadBatch extends AsyncTask<String, Integer, ArrayList<HashMap<String, String>>> {
        ...
        protected void onPostExecute(ArrayList<HashMap<String, String>> result) {
            ...
            ArrayAdapter<String> aa = new ArrayAdapter<String>(EC_number.this,R.layout.support_simple_spinner_dropdown_item, batchkombo);
    ...
    class LoadPhone extends AsyncTask<String, Void, String> {
        ...
        String url = "http://tom-mbuddy.com/android/nomor_penting.php";

        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(EC_number.this);
            ...
            try {
                ...
                if (success == 1) { //Ada record Data (SUCCESS = 1)
                    ...
                    for (int i = 0; i < daftarPhone.length(); i++) {
                        ...
                        tempNo = new NomorMod();
                        tempNo.setIdno(c.getString("id"));
                        tempNo.setNama(c.getString("ket") + " / " + c.getString("nama"));
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equalsIgnoreCase("Exception Caught")) {
                Toast.makeText(EC_number.this, "Unable to connect to server,please check your internet connection!", Toast.LENGTH_LONG).show();
            }

            if (result.equalsIgnoreCase("no results")) {
                Toast.makeText(EC_number.this, "Data empty", Toast.LENGTH_LONG).show();
            } else {
                //new SearchLocation().execute(batch);
                listViewPhone.setAdapter(new NomorAdapter(EC_number.this, daftar_phone));
                listViewPhone.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        LinearLayout layoutInput = new LinearLayout(EC_number.this);
                        layoutInput.setOrientation(LinearLayout.VERTICAL);
                        NomorMod no = new NomorMod();

                        final TextView vids = new TextView(EC_number.this);
                        vids.setText(Pids);
                        vids.setTextColor(Color.TRANSPARENT);
                        layoutInput.addView(vids);

                        final TextView vnama = new TextView(EC_number.this);
                        vnama.setText("   " + Pnama);
                        vnama.setTextColor(Color.parseColor("#FFFFFF"));
                        layoutInput.addView(vnama);

                        final Button tlp1 = new Button(EC_number.this);
                        tlp1.setText(Pnomor);
                        ...
                        final Button tlp2 = new Button(EC_number.this);
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(EC_number.this);
                        builder.setIcon(R.drawable.ic_people);
                        builder.setTitle("Detail Phone Number");
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
           startActivity(new Intent(EC_number.this, Utama.class));
            return true;
        }
