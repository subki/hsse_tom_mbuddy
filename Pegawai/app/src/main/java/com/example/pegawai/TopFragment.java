...
public class TopFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View top = inflater.inflate(R.layout.activity_top_fragment, container, false);

        nik = (TextView) getActivity().findViewById(R.id.nav_nik);
        tfnik = nik.getText().toString();

        new AsyncTaskTop().execute(tfnik);
    ...
    class AsyncTaskTop extends AsyncTask<String, Integer, ArrayList<HashMap<String, String>>> {
    ...
    public void isiTable(){
        ...
        TableLayout topLayout = (TableLayout) getActivity().findViewById(R.id.tableTop);
        ...
        if(topLayout != null) {
            int jml = topLayout.getChildCount();
            for (int i = 0; i < jml; i++) {
                View anak = topLayout.getChildAt(i);
        ...
        for (int i = 0; i < kode.size(); i++) {
           ...
           // tRow.addView(t4);
            ...
            topLayout.addView(tRow, new TableLayout.LayoutParams(
