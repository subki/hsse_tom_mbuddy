...
public class MiddleFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View middle = inflater.inflate(R.layout.activity_middle_fragment, container, false);

        nik = (TextView) getActivity().findViewById(R.id.nav_nik);
        tfnik = nik.getText().toString();


        new AsyncTaskMiddle().execute(tfnik);
    ...
    class AsyncTaskMiddle extends AsyncTask<String, Integer, ArrayList<HashMap<String, String>>> {
    ...
    public void isiTable(){
        ...
        TableLayout middleLayout = (TableLayout) getActivity().findViewById(R.id.tableMiddle);
        ...
        if(middleLayout != null) {
            int jml = middleLayout.getChildCount();
            for (int i = 0; i < jml; i++) {
                View anak = middleLayout.getChildAt(i);
        ...
        for (int i = 0; i < kode.size(); i++) {
            ...
            middleLayout.addView(tRow, new TableLayout.LayoutParams(
